...
//　デフォルトコンストラクタ
//===============================================================================
CMesh::CMesh(int nPriority, CScene::OBJTYPE objType) : CScene(nPriority, objType)
{
...
bool CMesh::GetHeight(D3DXVECTOR3 &pos)
{
	...
	int			nMeshX = (int)((posMtx.x) / (m_fMeshWidth / m_nMeshX));
	int			nMeshZ = (int)((posMtx.z) / (m_fMeshDepth / m_nMeshZ) * -1);
