...
#define WINDOW_MAX_TEXTURE			(7)								//TEXTUREの数
#define WINDOW_TextureName0		"data/TEXTURE/RockyHill.png"		//山
#define WINDOW_TextureName1		"data/TEXTURE/pipo-fog002.png"		//雲0
#define WINDOW_TextureName2		"data/TEXTURE/bg001.png"			//雲1
#define WINDOW_TextureName3		"data/TEXTURE/bg002.png"			//雲2
#define WINDOW_TextureName4		"data/TEXTURE/Title.png"			//Title
#define WINDOW_TextureName5		"data/TEXTURE/BgBuilding.jpg"			//Title
#define WINDOW_TextureName6		"data/TEXTURE/Result.png"		//Clear
...
void InitBGWindow(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, WINDOW_TextureName5, &g_pTextureBGWindow[5]);
	D3DXCreateTextureFromFile(pDevice, WINDOW_TextureName6, &g_pTextureBGWindow[6]);
