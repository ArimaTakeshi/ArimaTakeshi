...
// マクロ定義
//*****************************************************************************
#define TEXTURE_SIZE		(30)					//テクスチャサイズ
...
// セット処理
//=============================================================================
void CScene2D::Set(D3DXVECTOR3 pos, D3DXVECTOR2 nSize)
{
	//pos値代入
	m_pos = pos;
...
// セットと半径の処理
//=============================================================================
void CScene2D::SetRadius(D3DXVECTOR3 pos,float fRadius)
{
	//pos値代入
	m_pos = pos;
...
// アニメーション
//===============================================================================
void CScene2D::SetAnim(D3DXVECTOR2 nTex_UV,int nAnimPatteun)
{
	LPDIRECT3DDEVICE9 pDevice = CManager::GetRenderer()->GetDevice();
	...
	pVtx[0].tex = D3DXVECTOR2(nTex_UV.x * nAnimPatteun, 0.0f );
	pVtx[1].tex = D3DXVECTOR2(nTex_UV.x * nAnimPatteun + nTex_UV.x, 0.0f);
	pVtx[2].tex = D3DXVECTOR2(nTex_UV.x * nAnimPatteun, nTex_UV.y);
	pVtx[3].tex = D3DXVECTOR2(nTex_UV.x * nAnimPatteun + nTex_UV.x, nTex_UV.y);
...
// 背景のアニメーション
//===============================================================================
void CScene2D::SetBg(D3DXVECTOR2 *UV)
{
	//頂点情報へのポインタ
	VERTEX_2D *pVtx;
...
// 色を変える
//===============================================================================
void CScene2D::SetCol(D3DXCOLOR color)
{
	D3DXCOLOR col = color;
}
//===============================================================================
// 体力の頂点を左上にする
//===============================================================================
void CScene2D::SetLifeVtx(D3DXVECTOR3 pos,D3DXVECTOR2 size)
{
	//pos値代入
	m_pos = pos;
	...
	pVtx[1].pos = D3DXVECTOR3(m_pos.x + m_nSize.x, m_pos.y, 0.0f);
...
// 体力を減らしていく
//===============================================================================
void CScene2D::SetDamageLife(D3DXVECTOR2 *UV,float fDamage)
{
	//頂点情報へのポインタ
	VERTEX_2D *pVtx;
	...
	pVtx[1].tex = D3DXVECTOR2(UV->x - fDamage, UV->y);
	pVtx[2].tex = D3DXVECTOR2(UV->x, UV->y);
	pVtx[3].tex = D3DXVECTOR2(UV->x - fDamage, UV->y);
