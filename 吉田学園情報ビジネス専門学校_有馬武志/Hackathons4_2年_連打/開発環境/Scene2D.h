...
public:
	typedef enum
	{
		/* BG */		TEXTURE_Title, TEXTURE_Select, TEXTURE_VsSelect, TEXTURE_VsSelect2,
		/* UI */		TEXTURE_TitleLogo, TEXTURE_Marker, TEXTURE_TUTORIAL, TEXTURE_ITEM_TUTORIAL ,
		/*TIMEUP*/		TEXTURE_TimeUp,
		/*BG2*/			TEXTURE_Select2, TEXTURE_Window,
		/*斬撃*/		TEXTURE_Slashing0, TEXTURE_Slashing1,
		/*FADE*/		TEXTURE_Fade000,
		/*ロゴ*/		TEXTURE_LogoPress, TEXTURE_LogoSelect, TEXTURE_LogoPause,
						TEXTURE_LogoVersus, TEXTURE_LogoVsEnd,
		/*枠*/			TEX_UIWindow, TEX_VSWindow,
		/*クリア*/		TEX_CLEAR,
		/*オーバー*/	TEX_OVER, TEX_OVER2,
		/*ボス演出用*/	TEX_SPARK,
		TEXTURE_Title000hand, 
		TEXTURE_Title001hand,
		TEX_Game000,
		TEX_Result000,
		TEX_Result001,
		TEX_Result002,
