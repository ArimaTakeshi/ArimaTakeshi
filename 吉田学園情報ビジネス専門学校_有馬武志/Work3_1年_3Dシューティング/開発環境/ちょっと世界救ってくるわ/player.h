...
#define FILE_NAME				"data\\TEXT\\playermodel.txt"	//読み込むtxtファイルの名前
#define MAX_PARTS				(10)							//パーツ数
#define MODEL_SPEED				(1.0f)							//プレイヤースピード
#define MAX_PLAYERANIM			(12)							//アニメーション数
#define MAX_PLAYERKEY			(10)							//キーフレーム数
...
typedef struct
{
	...
	PlayerAnim		nAnimnuw;										//現在のアニメーション
