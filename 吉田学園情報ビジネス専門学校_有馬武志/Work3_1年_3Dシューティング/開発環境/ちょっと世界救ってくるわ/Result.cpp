...
// マクロ定義
//*************************************************************************************************************************
#define RESULT_TEXTURE_WIN		"data\\TEXTURE\\rizaruto.jpg"//読み込むテクスチャファイル
#define RESULT_TEXTURE_NOTWIN	"data\\TEXTURE\\rizaruto.jpg"//読み込むテクスチャファイル
...
void UpdateResult(void)
{
	...
	if (GetKeyboardTrigger(DIK_RETURN) == true || (nCount % 250) == 0 || GetMouseTrigger(0) == true)
	{
		//決定音
