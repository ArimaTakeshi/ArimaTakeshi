...
// マクロ定義
//*****************************************************************************
#define MESHWALL_TEXTURE_NAME		"data\\TEXTURE\\Bg001.jpg"							//読み込むテクスチャファイル
	...
	{//縦軸
		...
		{//横軸
		 //円柱
			...
			pVtx[0].pos.x = sinf((-D3DX_PI * (nCntCorss * ANGLE)))* 1500.0f;
			//pVtx[頂点番号].y = 縦のカウント回数　* 縦の幅
			pVtx[0].pos.y = nCntVertical * 250.0f;
			pVtx[0].pos.z = cosf((-D3DX_PI * (nCntCorss * ANGLE)))* 1500.0f;
