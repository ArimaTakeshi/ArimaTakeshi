...
{
	{ "data/BGM/戦争.wav", -1 },				// 戦争音BGM
	{ "data/BGM/飛行機中2.wav", -1 },		// 飛行機中BGM
	{ "data/BGM/ホラー.wav", -1 },			// タイトルBGM
	{ "data/BGM/ゲームちゅう.wav", -1 },		// ゲーム中BGM
	{ "data/SE/zyuusei.wav", 0 },				// 銃機
	{ "data/SE/開く2.wav", 0 },				// メニューを開く
	{ "data/SE/閉じる2.wav", 0 },				// メニューを閉じる
	{ "data/SE/決定.wav", 0 },				// 決定音
	{ "data/SE/メニュー移動2.wav", 0 },		// メニュー移動
	{ "data/SE/ヘリ通過_4.wav", 0 },		// メニュー移
};
