...
#define TUTORIAL_TEXTURE_NAME1 "data/TEXTURE/Tutorial000.jpg"	//読み込むテクスチャファイル
#define TUTORIAL_TEXTURE_NAME2 "data/TEXTURE/Tutorial001.jpg"							//読み込むテクスチャファイル
...
void UpdateTutolial(void)
{
	...
	//ページの進むor戻る
	if ((GetKeyboardTrigger(DIK_RIGHT) == true || GetKeyboardTrigger(DIK_RETURN) == true) && g_nPage < 2 || GetJoyPadTrigger(DIJS_BUTTON_12, 0) == true && g_nPage < 2)
	{//次のページへ進む
		for (nCntTutorial = 0, nInterval = 0; nCntTutorial < MAX_TUTORIAL; nCntTutorial++, nInterval += SCREEN_WIDTH)
		{
