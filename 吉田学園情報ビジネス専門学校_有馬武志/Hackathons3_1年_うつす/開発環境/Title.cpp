...
#define TITLE_TEXTURE_NAME_GI  "data/TEXTURE/title.png"   //読み込むテクスチャファイル
...
#define MAX_TITLE			   (1)					   //タイトル文字の最大数
#define TITLE_POS_X			   (SCREEN_WIDTH / 2 - 250)//タイトルの左上X座標
#define TITLE_POS_Y			   (-300)				   //タイトルの左上Y座標
#define TITLE_WIDTH			   (520)				   //タイトルの幅
#define TITLE_HEIGHT		   (520)				   //タイトルの高さ
...
void InitTitle(void)
{
	...
	InitWindow();
	SetWindow(D3DXVECTOR3(SCREEN_WIDTH * 0.1f, SCREEN_HEIGHT * 0.1f, 0.0f), D3DXCOLOR{ 1.0f,1.0f,1.0f, 1.0f }, 150, 100, 2, 0, 1, 1, 0, WINDOW_UPDATE_GAME, WINDOWSTATE_NORMAL, WINDOWUSE_GAME, WINDOWTYPE_CENTER, WINDOW_DRAW_1);
...
void UpdateTitle(void)
{
	...
	//ライトの更新処理
	UpdateLight();
	SetLight(D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.8f));
