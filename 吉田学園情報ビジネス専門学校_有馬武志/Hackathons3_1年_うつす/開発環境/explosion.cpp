...
#define EXPLOSION_MAX_TEX			(3)
#define EXPLOSION_TextureName		"data/TEXTURE/frameeffects102.png"
#define EXPLOSION_TextureName1		"data/TEXTURE/frameeffects103.png"//
#define EXPLOSION_TextureName2		"data/TEXTURE/kaenbeam.png"
	...
	for (nCntBullet = 0; nCntBullet < MAX_EXPLOSION; nCntBullet++)
	{
		...
		{//弾を前に飛ばす
		 //MessageBox(0, "本当すか？", "終了", MB_YESNO);
			...
			{//消えていく
				g_aExplosion[nCntBullet].col.a -= 0.012f;
