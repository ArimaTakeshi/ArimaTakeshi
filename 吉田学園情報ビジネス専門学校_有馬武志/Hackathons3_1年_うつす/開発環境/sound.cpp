...
{
	{ "data/BGM/タイトル.wav", -1 },			// タイトル
	{ "data/BGM/GAME.wav", -1 },			// ゲーム
	{ "data/BGM/プレイヤーの勝利.wav", 0 },	// リザルト
	{ "data/BGM/鬼の勝利.wav", 0 },			// ゲームオーバー
	{ "data/SE/カーソル.wav", 0 },			// カーソル
	{ "data/SE/Pボタン.wav", 0 },				// Pボタン
	{ "data/SE/決定音.wav", 0 },				// 決定音
	{ "data/SE/ゲーム開始時.wav", 0 },		// ゲーム開始時
	{ "data/SE/シャッター.wav", 0 },			// シャッター音
	{ "data/SE/心臓音.wav", 0 },				// 心臓音
	{ "data/SE/接近時.wav", 0 },				// 接近時
	{ "data/SE/プレイヤー死亡.wav", 0 },		// プレイヤー死亡
};
