...
HRESULT CRanking::Init(void)
{
	...
	CLogo::Create(D3DXVECTOR3(SCREEN_WIDTH / 1.35f - 30.0f, 200.0f, 0.0f), D3DXVECTOR2(100.0f, 30.0f), 1, 0);
	CLogo::Create(D3DXVECTOR3(SCREEN_WIDTH / 1.35f - 30.0f, 280.0f, 0.0f), D3DXVECTOR2(100.0f, 30.0f), 1, 0);
	CLogo::Create(D3DXVECTOR3(SCREEN_WIDTH / 1.35f - 30.0f, 360.0f, 0.0f), D3DXVECTOR2(100.0f, 30.0f), 1, 0);
	CLogo::Create(D3DXVECTOR3(SCREEN_WIDTH / 1.35f - 30.0f, 440.0f, 0.0f), D3DXVECTOR2(100.0f, 30.0f), 1, 0);
	CLogo::Create(D3DXVECTOR3(SCREEN_WIDTH / 1.35f - 30.0f, 520.0f, 0.0f), D3DXVECTOR2(100.0f, 30.0f), 1, 0);
	...
	for (int nCnt = 0; nCnt < MAX_RANKING; nCnt++)
	{
		for (int nCntNum = 0; nCntNum < TIME_MAX; nCntNum++)
		{
			if (m_RankTime[nCnt][nCntNum] != NULL)
			{
				...
				delete m_RankTime[nCnt][nCntNum];
