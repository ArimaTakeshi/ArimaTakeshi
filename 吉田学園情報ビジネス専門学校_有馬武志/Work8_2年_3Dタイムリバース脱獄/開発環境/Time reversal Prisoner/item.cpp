...
// マクロ定義
//*****************************************************************************
#define ITEM_NAME000		 "data\\MODEL\\Mark.x"		//テクスチャのファイル名
...
HRESULT CItem::Init(void)
{
	...
	//影の描画
	m_pShadow = CShadow::Create(D3DXVECTOR3(m_pos.x, m_pos.y - 50.0f, m_pos.z), 25.0f, 25.0f, 0);

	//数字の生成
	m_pDistance = CDistance::Create(D3DXVECTOR3(m_pos.x + 5.0f, m_pos.y + 10.0f, m_pos.z));
